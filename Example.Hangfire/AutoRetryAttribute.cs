...
public sealed class AutoRetryAttribute : JobFilterAttribute, IElectStateFilter, IApplyStateFilter
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AutoRetryAttribute"/>
